	...
	; modified disk communication items (end of this file)
	; to be located in common memory (RHK)
...
ccp	equ 0100h	; Console Command Processor gets loaded into the TPA
	...
	extrn ?time,timint		; signal time operation
...
sector$msg	db	', S-',0
   ...
   ; disk communication data items
   ; all moved to resident memory to facilitate RAMDISK
